...
templates['modal'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"modal container justify-content-center align-items-center h100 w100\" id=\""
    ...
    + "\">\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.isCloseable : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
